...
import projet_gestion_stock.consultation;
    ...
    public Recu() {
     ...
     public void inporter() {
       String colon[] = {"num_facture","code_produit","reference","prix_vente","stock_sortie","subtotal"};
        rs = db.fcSelectCommand(colon, "vente", "num_facture='" + consultation.txtfac.getText() + "'");
        tbleImp.setModel(new ResultSetTableModel(rs));
        lbltotal.setText(consultation.lbltot2.getText());
        lblcash.setText(consultation.txtcas.getText());
        payapres();
    }
...
// TODO add your handling code here:
     ...
     */
     ...
     public void date(){
        ...
        lbldate.setText(consultation.lbl1.getText());
        lblheure.setText(consultation.lbl2.getText());
    }

    public void payapres() {
        int a = Integer.parseInt(consultation.lbltot2.getText());
        int b = Integer.parseInt(consultation.txtcas.getText());
        int c = b - a;
